...
const FormField = ({ ...props }) => {
    return ((0, jsx_runtime_1.jsx)(FormFieldContext.Provider, { value: { name: props.name }, children: (0, jsx_runtime_1.jsx)(react_hook_form_7_55_0_1.Controller, { ...props }) }));
};
...
function FormControl({ ...props }) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_slot_1_1_2_1.Slot, { "data-slot": "form-control", id: formItemId, "aria-describedby": !error
            ? `${formDescriptionId}`
