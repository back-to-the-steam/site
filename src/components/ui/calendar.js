...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
    return ((0, jsx_runtime_1.jsx)(react_day_picker_8_10_1_1.DayPicker, { showOutsideDays: showOutsideDays, className: (0, utils_1.cn)("p-3", className), classNames: {
            ...
            IconLeft: ({ className, ...props }) => ((0, jsx_runtime_1.jsx)(lucide_react_0_487_0_1.ChevronLeft, { className: (0, utils_1.cn)("size-4", className), ...props })),
            IconRight: ({ className, ...props }) => ((0, jsx_runtime_1.jsx)(lucide_react_0_487_0_1.ChevronRight, { className: (0, utils_1.cn)("size-4", className), ...props })),
        }, ...props }));
}
